            ...
            with open(self.file_path, "r") as file:
                ...
                for line in file:
                    try:
                        ...
                        if key == 'checkpoints':
                            self.checkpoints = eval(value)  # Avoid using eval in production
                        elif key == 'checkpoint_data':
                            self.checkpoint_data = eval(value)  # Avoid using eval in production
...
def main():
    record = DUI_Checkpoint_Record("dummy.txt")
    ...
    while True:
        ...
        if choice == '1':
            ...
            print("Exiting the program! Thank")
            break
        else:
